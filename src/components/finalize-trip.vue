    ...
    <b-card class="">
      ...
      <ValidationObserver ref="form">
        <form @submit.prevent="addForm" class="mega-form-settlement">
          ...
          <b-row class="mt-5">
            <b-col>
              <label for="input-live">Scan Barcode</label>
              <b-form-input
                id="input-live"
                v-model="name"
                :state="nameState"
          ...
          <b-row class="mt-2">
            <b-col cols="6">
            <h3>Daftar DO</h3>
              <b-table :show-empty="true" bordered striped hover :fields="fields"></b-table>
              <b-button class="btn-block btn-mega">Simpan</b-button>
            </b-col>
            <b-col cols="6">
            <h3>Daftar Serial</h3>
              <b-table :show-empty="true" bordered striped hover :fields="fields"></b-table>
